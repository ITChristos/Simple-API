...
The end result will now be avialable at http://**username**.github.io/**name-of-repo**/objects.json.  For instance,  [http://ITChristos.github.io/Simple-API/objects.json]
...
The end result will now be avialable at http://**username**.github.io/**name-of-repo**/objects.xml.  For instance,  [http://ITChristos.github.io/Simple-API/objects.xml]
...
The end result will now be avialable at http://**username**.github.io/**name-of-repo**/objects.csv.  For instance, [http://ITChristos.github.io/Simple-API/objects.csv].
...
````
The end result will now be avialable at http://**username**.github.io/**name-of-repo**/.  For instance, [http://ITChristos.github.io/Simple-API/].
